!(function (e, t) {
  ...
  var ue = (function () {
    ...
    return function (a, u) {
      ...
      for (var h, f = a.length, d = [], p = 0; p < f; ++p)
        d.push(
      ...
      for (var y = 0, b = c; y < f; ++y) {
        ...
        "1" == w && "r" == b
          ? (d[y] = "n")
          : i.test(w) && ((b = w), "r" == w && (d[y] = "R"));
      }
      for (var x = 1, C = d[0]; x < f - 1; ++x) {
        var S = d[x];
        "+" == S && "1" == C && "1" == d[x + 1]
          ? (d[x] = "1")
          : "," != S || C != d[x + 1] || ("1" != C && "n" != C) || (d[x] = C),
          (C = S);
      }
      for (var L = 0; L < f; ++L) {
        var k = d[L];
      ...
      return (
        "ltr" == u &&
          (1 == R[0].level &&
            (I = a.match(/^\s+/)) &&
            ((R[0].from = I[0].length), R.unshift(new s(0, 0, I[0].length))),
          1 == $(R).level &&
            (I = a.match(/\s+$/)) &&
            (($(R).to -= I[0].length), R.push(new s(0, f - I[0].length, f)))),
        "rtl" == u ? R.reverse() : R
      );
    };
  })();
    ...
    if (null == Te) {
      ...
      N(e, O("span", [t, document.createTextNode("x")])),
        0 != e.firstChild.offsetHeight &&
          (Te = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(l && s < 8));
    }
    var r = Te
      ? O("span", "​")
      : O(
  ...
  var De,
    ...
    Fe =
      "oncopy" in (De = O("div")) ||
      (De.setAttribute("oncopy", "return;"), "function" == typeof De.oncopy),
    Pe = null;
  var Ee = {},
    Ie = {};
  function Re(e) {
  ...
  function dt(e, t, r) {
    ...
    var o = (function (e, t, r) {
        for (
          ...
          if (
            u &&
            (!r || s + (u instanceof ut ? u.lookAhead : 0) <= o.modeFrontier)
          )
            return s;
    ...
    for ("" == t && bt(gt(r, n.state), o); !h.eol(); ) {
      if (
        (h.pos > e.options.maxHighlightLength
          ? ((s = !1), l && pt(e, t, n, h.pos), (h.pos = t.length), (a = null))
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            if (
              ...
              (n || (n = [])).push(
                new St(l, s ? null : o.from - t, null == o.to ? null : o.to - t)
              );
            }
          }
        return n;
    ...
    if (a)
      for (var p = 0; p < a.length; ++p) {
        ...
        if ((null != g.to && (g.to += c), null == g.from))
          Lt(s, g.marker) || ((g.from = c), u && (s || (s = [])).push(g));
    ...
    if (!u) {
      ...
      if (y > 0 && s)
        for (var b = 0; b < s.length; ++b)
          null == s[b].to &&
            (m || (m = [])).push(new St(s[b].marker, null, null));
  ...
  function Zt(e, t) {
    ...
    for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
      ...
      (n.pos = 0),
        ...
        Ae(e.display.measure) &&
          (l = ce(o, e.doc.direction)) &&
          (n.addToken = er(n.addToken, l)),
        (n.map = []),
        rr(o, n, ft(e, o, t != e.display.externalMeasured && qe(o))),
        o.styleClasses &&
        ...
        0 == n.map.length &&
          n.map.push(0, 0, n.content.appendChild(Oe(e.display.measure))),
        0 == i
    ...
    return (
      ge(e, "renderLine", e, t.line, n.pre),
          ...
          if ("\t" == p[0]) {
            ...
            "\r" == p[0] || "\n" == p[0]
              ...
              : ((m = e.cm.options.specialCharPlaceholder(p[0])).setAttribute(
                ...
                l && s < 9 ? u.appendChild(O("span", [m])) : u.appendChild(m),
                (e.col += 1));
  ...
  function nr(e, t, r) {
    (this.line = t),
      ...
      (this.size = this.rest ? qe($(this.rest)) - r + 1 : 1),
  ...
  function fr(e, t) {
    ...
    t.text == t.node && (t.node = n.pre),
      ...
      n.bgClass != t.bgClass || n.textClass != t.textClass
        ? ((t.bgClass = n.bgClass), (t.textClass = n.textClass), dr(e, t))
  ...
  function Dr(e, t) {
    ...
    n && !n.text
      ? (n = null)
      : n && n.changes && (ur(e, n, r, rn(e)), (e.curOp.forceUpdate = !0)),
      n ||
        (n = (function (e, t) {
          var r = qe((t = Rt(t))),
                ...
                if (
                  (i =
                    l && s < 9 && 0 == u && c == o.coverEnd - o.coverStart
                      ...
                      : Er(k(a, u, c).getClientRects(), n)).left ||
                  i.right ||
                  0 == u
                )
                  break;
  ...
  function Vr(e, t, r, n, i) {
    ...
    var l = Vt(t);
    if (
      ("local" == n ? (l += Cr(e.display)) : (l -= e.display.viewOffset),
      "page" == n || "window" == n)
    ) {
  ...
  function $r(e, t, r) {
    ...
    var i = Ze(n, r),
      o = n.first + n.size - 1;
    if (i > o)
      return _r(n.first + n.size - 1, Xe(n, o).text.length, null, 1, 1);
    t < 0 && (t = 0);
    for (var l = Xe(n, i); ; ) {
      var s = Jr(e, l, i, t, r),
      ...
      var h = (e.options.lineWrapping
        ? function (e, t, r, n, i, o, l) {
            ...
            for (var c = null, h = null, f = 0; f < i.length; f++) {
              ...
              if (!(d.from >= u || d.to <= a)) {
                var p = 1 != d.level,
                  g = Wr(e, n, p ? Math.min(u, d.to) - 1 : Math.max(a, d.from))
                    .right,
                  v = g < o ? o - g + 1e9 : g - o;
                (!c || h > v) && ((c = d), (h = v));
              }
        ...
        : function (e, t, r, n, i, o, l) {
            var s = le(
                function (s) {
                  ...
                  return Qr(
                    Xr(
                      e,
                      et(r, u ? a.to : a.from, u ? "before" : "after"),
                      "line",
                      t,
                      n
                    ),
            ...
            if (s > 0) {
              var u = 1 != a.level,
                c = Xr(
                  e,
                  et(r, u ? a.from : a.to, u ? "after" : "before"),
                  "line",
                  t,
                  n
                );
  ...
  function en(e) {
    ...
    if (null == Hr) {
      ...
      for (var t = 0; t < 49; ++t)
        Hr.appendChild(document.createTextNode("x")), Hr.appendChild(O("br"));
  ...
  function sn(e, t, r, n) {
    ...
    if (n && u.xRel > 0 && (a = Xe(e.doc, u.line).text).length == u.ch) {
      ...
      u = et(
        u.line,
        Math.max(0, Math.round((o - Lr(e.display).left) / tn(e.display)) - c)
      );
    }
    return u;
  }
    ...
    (e.state.delayingBlurEvent = !0),
      setTimeout(function () {
        e.state.delayingBlurEvent &&
          ((e.state.delayingBlurEvent = !1), e.state.focused && Sn(e));
      }, 100);
  }
  function Cn(e, t) {
    e.state.delayingBlurEvent &&
        ...
        if (l && s < 8) {
          ...
          (a = h.bottom - h.top),
            !o &&
              i.text.firstChild &&
              (u =
                i.text.firstChild.getBoundingClientRect().right - h.left - 1);
        }
        var f = i.line.height - a;
        if ((f > 0.005 || f < -0.005) && ($e(i.line, a), kn(i.line), i.rest))
  ...
  function Tn(e, t, r) {
    ...
    if (r && r.ensure) {
      var s = r.ensure.from.line,
        a = r.ensure.to.line;
      s < o
        ? ((o = s), (l = Ze(t, Vt(Xe(t, s)) + e.wrapper.clientHeight)))
        : Math.min(a, t.lastLine()) >= l &&
          ((o = Ze(t, Vt(Xe(t, a)) - e.wrapper.clientHeight)), (l = a));
    }
  ...
  function Dn(e) {
    ...
    t &&
      ...
      Wn(e, Yr(e, t.from), Yr(e, t.to), t.margin));
  }
  function Wn(e, t, r, n) {
    var i = Mn(e, {
  ...
  function Hn(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 ||
      (r || oi(e, { top: t }), Fn(e, t, !0), r && oi(e), ei(e, 100));
  }
  function Fn(e, t, r) {
    (t = Math.max(
      0,
  ...
  function zn(e, t) {
    ...
    for (
      ...
      r != e.display.barWidth && e.options.lineWrapping && Ln(e),
        Bn(e, En(e)),
  ...
  function Un(e) {
    e.display.scrollbars &&
      ...
      (e.display.scrollbars = new Gn[e.options.scrollbarStyle](
        function (t) {
  ...
  function _n(e) {
    ...
    null != e.adjustWidthTo &&
      ...
      e.maxScrollLeft < t.doc.scrollLeft &&
        Pn(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
  ...
  function $n(e) {
        ...
        if (!ve(e, "scrollCursorIntoView")) {
          ...
          if (
            ...
            var o = O(
              ...
              null,
              "position: absolute;\n                         top: " +
                (t.top - r.viewOffset - Cr(e.display)) +
                "px;\n                         height: " +
          ...
          null == n && (n = 0),
            e.options.lineWrapping ||
              ...
              (r =
                "before" ==
                (t = t.ch
                  ? et(t.line, "before" == t.sticky ? t.ch - 1 : t.ch, "after")
                  : t).sticky
    ...
    if (o)
      for (var s = 0; s < o.length; ++s)
        o[s].lines.length && ge(o[s], "unhide");
  ...
  function ei(e, t) {
    e.doc.highlightFrontier < e.display.viewTo &&
      e.state.highlight.set(t, E(ti, e));
  }
  function ti(e) {
    var t = e.doc;
      ...
      t.iter(
        ...
        function (o) {
          if (n.line >= e.display.viewFrom) {
            ...
            o.text.length <= e.options.maxHighlightLength && pt(e, o.text, n),
    ...
    !(function (e, t, r) {
      ...
      0 == n.view.length || t >= n.viewTo || r <= n.viewFrom
        ...
        : (n.viewFrom > t
            ...
            : n.viewFrom < t && (n.view = n.view.slice(an(e, t))),
          (n.viewFrom = t),
          n.viewTo < r
            ? (n.view = n.view.concat(ir(e, n.viewTo, r)))
            : n.viewTo > r && (n.view = n.view.slice(0, an(e, r)))),
        (n.viewTo = r);
    })(e, o, l),
      ...
      (function (e, t, r) {
        ...
        for (var u = n.view, c = n.viewFrom, h = 0; h < u.length; h++) {
          ...
          if (f.hidden);
            ...
            f.changes &&
              (B(f.changes, "gutter") > -1 && (d = !1), ur(e, f, c, r)),
              d &&
                (M(f.lineNumber),
  ...
  function ii(e, t) {
    for (var r = t.viewport, n = !0; ; n = !1) {
      if (n && e.options.lineWrapping && t.oldDisplayWidth != Tr(e))
        n && (t.visible = Tn(e.display, e.doc, r));
      else if (
        (r &&
          null != r.top &&
          (r = { top: Math.min(e.doc.height + Sr(e.display) - Mr(e), r.top) }),
  ...
  function ui(e) {
    ...
    if (r.length != n.lineNumChars) {
      var i = n.measure.appendChild(
          O("div", [O("div", r)], "CodeMirror-linenumber CodeMirror-gutter-elt")
        ),
  ...
  function yi(e, t) {
    ...
    if ((i && u) || (o && c)) {
      if (o && y && a)
        e: for (var f = t.target, d = l.view; f != s; f = f.parentNode)
      ...
      if (i && !r && !h && null != gi)
        return (
          o && c && Hn(e, Math.max(0, s.scrollTop + o * gi)),
          Pn(e, Math.max(0, s.scrollLeft + i * gi)),
          (!o || (o && c)) && we(t),
            ...
            setTimeout(function () {
              if (null != l.wheelStartX) {
                ...
                (l.wheelStartX = l.wheelStartY = null),
                  r && ((gi = (gi * pi + r) / (pi + 1)), ++pi);
              }
            }, 200))
          : ((l.wheelDX += i), (l.wheelDY += o)));
    }
  }
  l ? (gi = -0.53) : r ? (gi = 15) : c ? (gi = -0.7) : f && (gi = -1 / 3);
  var bi = function (e, t) {
  ...
  (bi.prototype.primary = function () {
    ...
    (bi.prototype.deepCopy = function () {
      for (var e = [], t = 0; t < this.ranges.length; t++)
        e[t] = new wi(nt(this.ranges[t].anchor), nt(this.ranges[t].head));
      return new bi(e, this.primIndex);
    }),
    ...
    (bi.prototype.contains = function (e, t) {
      t || (t = e);
  ...
  function xi(e, t, r) {
    ...
    for (var o = 1; o < t.length; o++) {
      ...
      if (n && !l.empty() ? a > 0 : a >= 0) {
        ...
        o <= r && --r, t.splice(--o, 2, new wi(h ? c : u, h ? u : c));
      }
    }
    return new bi(t, r);
  }
  function Ci(e, t) {
    return new bi([new wi(e, t || e)], 0);
  }
  function Si(e) {
    return e.text
      ? et(
  ...
  function Li(e, t) {
    ...
    var r = e.line + t.text.length - (t.to.line - t.from.line) - 1,
      n = e.ch;
    return e.line == t.to.line && (n += Si(t).ch - t.to.ch), et(r, n);
  }
  function ki(e, t) {
    for (var r = [], n = 0; n < e.sel.ranges.length; n++) {
      var i = e.sel.ranges[n];
      r.push(new wi(Li(i.anchor, t), Li(i.head, t)));
    }
  ...
  function Pi(e, t) {
    var r = { from: nt(t.from), to: Si(t), text: Ye(e, t.from, t.to) };
    return (
  ...
  function ji(e, t, r, n, i) {
    null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
      qi(e, new bi([Ki(e.sel.primary(), t, r, i)], 0), n);
  }
  function Xi(e, t, r) {
    for (
    ...
    qi(e, xi(e.cm, n, e.sel.primIndex), r);
  }
  function Yi(e, t, r, n) {
    var i = e.sel.ranges.slice(0);
    (i[t] = r), qi(e, xi(e.cm, i, e.sel.primIndex), n);
  }
  function _i(e, t, r, n) {
    qi(e, Ci(t, r), n);
  }
  function $i(e, t, r) {
    var n = e.history.done,
      i = $(n);
    i && i.ranges ? ((n[n.length - 1] = t), Zi(e, t, r)) : qi(e, t, r);
  }
  function qi(e, t, r) {
    Zi(e, t, r), Ri(e, e.sel, e.cm ? e.cm.curOp.id : NaN, r);
  }
  function Zi(e, t, r) {
        ...
        var n = {
          ...
          update: function (t) {
            ...
            for (var r = 0; r < t.length; r++)
              this.ranges[r] = new wi(st(e, t[r].anchor), st(e, t[r].head));
          },
          origin: r && r.origin,
        };
        return (
          ge(e, "beforeSelectionChange", e, n),
          e.cm && ge(e.cm, "beforeSelectionChange", e.cm, n),
          n.ranges != t.ranges ? xi(e.cm, n.ranges, n.ranges.length - 1) : t
        );
      })(e, t, r));
    var n =
      (r && r.bias) ||
  ...
  function eo(e, t, r, n) {
    for (var i, o = 0; o < t.ranges.length; o++) {
      var l = t.ranges[o],
        ...
        a = ro(e, l.anchor, s && s.anchor, r, n),
        u = ro(e, l.head, s && s.head, r, n);
      (i || a != l.anchor || u != l.head) &&
        (i || (i = t.ranges.slice(0, o)), (i[o] = new wi(a, u)));
    }
      ...
      for (var l = 0; l < o.markedSpans.length; ++l) {
        ...
        if (
          ...
          if (r) {
            ...
            if (
              ((n < 0 ? c : u) &&
                (h = no(e, h, -n, h && h.line == t.line ? o : null)),
              h &&
                h.line == t.line &&
                (f = tt(h, r)) &&
                (n < 0 ? f < 0 : f > 0))
          ...
          return (
            (n < 0 ? u : c) && (d = no(e, d, n, d.line == t.line ? o : null)),
            d ? to(e, d, t, n, i) : null
          );
        }
      }
  ...
  function lo(e, t, r) {
    if (e.cm) {
      if (!e.cm.curOp) return Zn(e.cm, lo)(e, t, r);
  ...
  function so(e, t) {
    if (1 != t.text.length || "" != t.text[0] || 0 != tt(t.from, t.to)) {
      var r = ki(e, t);
      Ii(e, t, r, e.cm ? e.cm.curOp.id : NaN), co(e, t, r, Tt(e, t));
      var n = [];
      Di(e, function (e, r) {
        r || -1 != B(n, e.history) || (go(e.history, t), n.push(e.history)),
          co(e, t, null, Tt(e, t));
      });
    }
  }
  function ao(e, t, r) {
    ...
    if (!n || r) {
      ...
      if (u != s.length) {
        ...
        for (
          var h = ye(e, "beforeChange") || (e.cm && ye(e.cm, "beforeChange")),
            f = function (r) {
              var n = i.changes[r];
              if (((n.origin = t), h && !oo(e, n, !1)))
                return (s.length = 0), {};
              c.push(Pi(e, n));
              var o = r ? ki(e, n) : $(s);
              co(e, n, o, Ui(e, n)),
                !r && e.cm && e.cm.scrollIntoView({ from: n.from, to: Si(n) });
              var l = [];
              Di(e, function (e, t) {
                t ||
                  -1 != B(l, e.history) ||
                  (go(e.history, n), l.push(e.history)),
                  co(e, n, null, Ui(e, n));
              });
            },
      ...
      t.to.line > o &&
        ...
        e.cm
          ? (function (e, t, r) {
              ...
              t.full
                ? un(e)
                : o.line != l.line || 1 != t.text.length || Oi(e.doc, t)
                ? un(e, o.line, l.line + 1, u)
                : cn(e, o.line, "text");
              var c = ye(e, "changes"),
                h = ye(e, "change");
              if (h || c) {
  ...
  function ho(e, t, r, n, i) {
    ...
    n || (n = r),
      ...
      lo(e, { from: r, to: n, text: t, origin: i });
  }
  function fo(e, t, r, n) {
  ...
  function vo(e, t, r, n) {
    var i = t,
      o = t;
    return (
      "number" == typeof t ? (o = Xe(e, lt(e, t))) : (i = qe(t)),
      null == i ? null : (n(o, i) && e.cm && cn(e.cm, i, r), o)
    );
  }
  function mo(e) {
          ...
          if (e <= o) {
            if ((i.insertInner(e, t, r), i.lines && i.lines.length > 50)) {
              for (
                ...
                var a = new mo(i.lines.slice(s, (s += 25)));
                (i.height -= a.height),
  ...
  function So(e, t, r, n, i) {
    ...
    if (e.cm && !e.cm.curOp) return Zn(e.cm, So)(e, t, r, n, i);
    var o = new Co(e, i),
      l = tt(t, r);
    ...
    if (
      (e.iter(a, r.line + 1, function (e) {
        u &&
          ...
          (function (e, t) {
            ...
            e,
            new St(o, a == t.line ? t.ch : null, a == r.line ? r.ch : null)
          ),
          ++a;
      }),
      o.collapsed &&
      ...
      o.atomic && Ji(u.doc), sr(u, "markerAdded", u, o);
    }
    return o;
  }
  (Co.prototype.clear = function () {
    if (!this.explicitlyCleared) {
      ...
      for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
        ...
        e && !this.collapsed
          ? cn(e, qe(l), "text")
          : e && (null != s.to && (i = qe(l)), null != s.from && (n = qe(l))),
      ...
      null != n && e && this.collapsed && un(e, n, i + 1),
        (this.lines.length = 0),
    ...
    (Co.prototype.find = function (e, t) {
      ...
      for (var i = 0; i < this.lines.length; ++i) {
        ...
        if (null != l.from && ((r = et(t ? o : qe(o), l.from)), -1 == e))
          return r;
    ...
    (Co.prototype.changed = function () {
      ...
      t &&
        ...
        qn(n, function () {
          ...
          if (
            (l &&
              (Ir(l), (n.curOp.selectionChanged = n.curOp.forceUpdate = !0)),
  ...
  (Lo.prototype.clear = function () {
    ...
    be(Lo);
  var Mo = 0,
    No = function (e, t, r, n, i) {
      if (!(this instanceof No)) return new No(e, t, r, n, i);
      null == r && (r = 0),
        yo.call(this, [new mo([new Xt("", null)])]),
        (this.first = r),
  ...
  (No.prototype = Q(yo.prototype, {
    ...
    replaceRange: function (e, t, r, n) {
      ho(this, e, (t = st(this, t)), (r = r ? st(this, r) : t), n);
    },
    ...
    setCursor: Jn(function (e, t, r) {
      _i(this, st(this, "number" == typeof e ? et(e, t || 0) : e), null, r);
    }),
    setSelection: Jn(function (e, t, r) {
      _i(this, st(this, e), st(this, t || e), r);
    }),
    extendSelection: Jn(function (e, t, r) {
      ji(this, st(this, e), t && st(this, t), r);
    }),
    extendSelections: Jn(function (e, t) {
      Xi(this, at(this, e), t);
    }),
    extendSelectionsBy: Jn(function (e, t) {
      Xi(this, at(this, q(this.sel.ranges, e)), t);
    }),
    setSelections: Jn(function (e, t, r) {
      if (e.length) {
        for (var n = [], i = 0; i < e.length; i++)
          n[i] = new wi(st(this, e[i].anchor), st(this, e[i].head));
        null == t && (t = Math.min(e.length - 1, this.sel.primIndex)),
          qi(this, xi(this.cm, n, t), r);
      }
    }),
    addSelection: Jn(function (e, t, r) {
      var n = this.sel.ranges.slice(0);
      n.push(new wi(st(this, e), st(this, t || e))),
        qi(this, xi(this.cm, n, n.length - 1), r);
    }),
            ...
            (function (e, t, r) {
              for (
                ...
                if (((i = s.to), (o = u), "around" == r)) {
                  ...
                  n[l] = new wi(h ? u : a, h ? a : u);
                } else n[l] = new wi(a, a);
              }
              return new bi(n, e.sel.primIndex);
            })(this, n, t),
          a = n.length - 1;
        a >= 0;
        a--
    ...
    addLineWidget: Jn(function (e, t, r) {
      return (function (e, t, r, n) {
        ...
        return (
          ...
          o && sr(o, "lineWidgetAdded", o, i, "number" == typeof t ? t : qe(t)),
          i
        );
      })(this, e, t, r);
    }),
    ...
    markText: function (e, t, r) {
      return So(this, st(this, e), st(this, t), r, (r && r.type) || "range");
    },
    setBookmark: function (e, t) {
      ...
      return So(this, (e = st(this, e)), e, r, "bookmark");
    },
        ...
        (function (e, t) {
          for (var r = 0; r < t.length; r++) {
            var n = t[r],
              ...
              l = e.clipPos(i.to);
            if (tt(o, l)) {
              var s = So(e, o, l, n.primary, n.primary.type);
    ...
    unlinkDoc: function (e) {
      if ((e instanceof Ll && (e = e.doc), this.linked))
        for (var t = 0; t < this.linked.length; ++t) {
          if (this.linked[t].doc == e) {
            this.linked.splice(t, 1), e.unlinkDoc(this), To(ko(this));
            break;
          }
        }
      if (e.history == this.history) {
        ...
        Di(
          ...
          (e.history.done = Vi(this.history.done, r)),
          (e.history.undone = Vi(this.history.undone, r));
      }
    },
              ...
              a = function () {
                ++s == i &&
                  Zn(t, function () {
                    ...
                    lo(t.doc, e), $i(t.doc, Ci(st(t.doc, r), st(t.doc, Si(e))));
                  })();
              },
              u = function (e, r) {
                if (
  ...
  for (var zo = 1; zo <= 12; zo++) Eo[zo + 111] = Eo[zo + 63235] = "F" + zo;
  var Bo = {};
  function Go(e) {
    var t,
      r,
  ...
  function Xo(e, t) {
    ...
    return (
      null != r &&
      !e.altGraphKey &&
      (3 == e.keyCode && e.code && (r = e.code), jo(r, e, t))
    );
  }
  function Yo(e) {
  ...
  var Qo = {
    ...
    goLineLeftSmart: function (e) {
      return e.extendSelectionsBy(function (t) {
        ...
        return n.ch < e.getLine(n.line).search(/\S/) ? el(e, t.head) : n;
      }, j);
    },
    goLineUp: function (e) {
      ...
      return qn(e, function () {
        for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++)
          if (t[n].empty()) {
            ...
            if (o)
              if (
                (i.ch == o.length && (i = new et(i.line, i.ch - 1)), i.ch > 0)
              )
  ...
  function Jo(e, t) {
    var r = Xe(e.doc, t),
      n = Rt(r);
    return n != r && (t = qe(n)), Zo(!0, e, n, t, 1);
  }
  function el(e, t) {
    var r = Jo(e, t.line),
      n = Xe(e.doc, r.line),
  ...
  function il(e, t, r, n) {
    var i = (function (e, t, r) {
      ...
      return (
        (e.options.extraKeys && Vo(t, e.options.extraKeys, r, e)) ||
        Vo(t, e.options.keyMap, r, e)
      );
    })(e, t, n);
    return (
  ...
  function ul(e) {
    ...
    if (
      ...
      var r = e.keyCode,
        n = e.charCode;
      if (h && r == ll) return (ll = null), void we(e);
      if (!h || (e.which && !(e.which < 10)) || !ol(t, e)) {
      ...
      if ((r.input.ensurePolled(), (r.shift = e.shiftKey), xr(r, e)))
        ...
        var n = sn(t, e),
          ...
          o = n
            ? (function (e, t) {
                var r = +new Date();
                return hl && hl.compare(r, e, t)
                  ? ((cl = hl = null), "triple")
                  : cl && cl.compare(r, e, t)
                  ? ((hl = new fl(r, e, t)), (cl = null), "double")
                  : ((cl = new fl(r, e, t)), (hl = null), "single");
              })(n, i)
            : "single";
        window.focus(),
          ...
          (n &&
            ...
            (1 == i
              ? n
                ? (function (e, t, r, n) {
                    ...
                    (tt(i.to(), t) > 0 || t.xRel < 0)
                      ...
                      : (function (e, t, r, n) {
                          ...
                          n.addNew && !n.extend
                            ? ((a = o.sel.contains(r)),
                              (s = a > -1 ? c[a] : new wi(r, r)))
                            : ((s = o.sel.primary()), (a = o.sel.primIndex));
                          if ("rectangle" == n.unit)
                            n.addNew || (s = new wi(r, r)),
                              (r = sn(e, t, !0, !0)),
                              (a = -1);
                          else {
                            var h = pl(e, r, n.unit);
                            s = n.extend
                              ? Ki(s, h.anchor, h.head, n.extend)
                              : h;
                          }
                          n.addNew
                            ? -1 == a
                              ? ((a = c.length),
                                qi(o, xi(e, c.concat([s]), a), {
                                  scroll: !1,
                                  origin: "*mouse",
                                }))
                              : c.length > 1 &&
                            ...
                            if (0 != tt(f, t))
                              if (((f = t), "rectangle" == n.unit)) {
                                for (
                                  var i = [],
                                    l = e.options.tabSize,
                                    c = R(Xe(o, r.line).text, r.ch, l),
                                    h = R(Xe(o, t.line).text, t.ch, l),
                                    d = Math.min(c, h),
                                    p = Math.max(c, h),
                                  ...
                                  var m = Xe(o, g).text,
                                    y = X(m, d, l);
                                  d == p
                                    ? i.push(new wi(et(g, y), et(g, y)))
                                    : m.length > y &&
                                      i.push(
                                        new wi(et(g, y), et(g, X(m, p, l)))
                                      );
                                }
                                i.length || i.push(new wi(r, r)),
                                  qi(
                                    o,
                                    xi(e, u.ranges.slice(0, a).concat(i), a),
                                ...
                                var b,
                                  ...
                                  C = w.anchor;
                                tt(x.anchor, C) > 0
                                  ? ((b = x.head), (C = ot(w.from(), x.anchor)))
                                  : ((b = x.anchor), (C = it(w.to(), x.head)));
                ...
                : Le(e) == r.scroller && we(e)
              : 2 == i
              ? (n && ji(t.doc, n),
                setTimeout(function () {
                  return r.input.focus();
                }, 20))
              : 3 == i && (S ? t.display.input.onContextMenu(e) : xn(t)));
      }
  }
  function pl(e, t, r) {
    if ("char" == r) return new wi(t, t);
    if ("word" == r) return e.findWordAt(t);
    if ("line" == r) return new wi(et(t.line, 0), st(e.doc, et(t.line + 1, 0)));
    var n = r(e, t);
    return new wi(n.from, n.to);
  }
  function gl(e, t, r, n) {
    var i, o;
    ...
    for (var a = 0; a < e.display.gutterSpecs.length; ++a) {
      ...
      if (u && u.getBoundingClientRect().right >= i)
        return (
          ge(e, r, e, Ze(e.doc, o), e.display.gutterSpecs[a].className, t),
          Ce(t)
        );
    }
  }
  ...
  function ml(e, t) {
    xr(e.display, t) ||
      (function (e, t) {
        ...
        return gl(e, t, "gutterContextMenu", !1);
      })(e, t) ||
      ve(e, t, "contextmenu") ||
      S ||
  ...
  function Ll(e, t) {
    var r = this;
    if (!(this instanceof Ll)) return new Ll(e, t);
    (this.options = t = t ? I(t) : {}), I(wl, t, !1);
    var n = t.value;
    "string" == typeof n
      ? (n = new No(n, t.mode, null, t.lineSeparator, t.direction))
      : t.mode && (n.modeOption = t.mode),
      (this.doc = n);
    var i = new Ll.inputStyles[t.inputStyle](this),
      o = (this.display = new di(e, n, i, t));
    ...
    (function (e) {
      var t = e.display;
      fe(t.scroller, "mousedown", Zn(e, dl)),
        fe(
          t.scroller,
          "dblclick",
          l && s < 11
      ...
      fe(t.scroller, "contextmenu", function (t) {
        ...
        fe(t.input.getField(), "contextmenu", function (r) {
          t.scroller.contains(r.target) || ml(e, r);
        });
      var r,
        n = { end: 0 };
      function i() {
      ...
      fe(t.scroller, "touchstart", function (i) {
          ...
          if (
            ...
            (l =
              !n.prev || o(n, n.prev)
                ...
                ? e.findWordAt(s)
                : new wi(et(s.line, 0), st(e.doc, et(s.line + 1, 0)))),
        ...
        (t.dragFunctions = {
          ...
          start: function (t) {
            return (function (e, t) {
              if (l && (!e.state.draggingText || +new Date() - Oo < 100)) Se(t);
              else if (
                !ve(e, t) &&
                !xr(e.display, t) &&
      ...
      fe(a, "keyup", function (t) {
        ...
        fe(a, "keydown", Zn(e, sl)),
        fe(a, "keypress", Zn(e, ul)),
        fe(a, "focus", function (t) {
          return Cn(e, t);
        }),
    ...
    (t.autofocus && !m) || this.hasFocus()
      ...
      : Sn(this),
    xl))
      xl.hasOwnProperty(u) && xl[u](this, t[u], bl);
    ui(this), t.finishInit && t.finishInit(this);
    for (var c = 0; c < kl.length; ++c) kl[c](this);
    jn(this),
      a &&
        t.lineWrapping &&
  ...
  (Ll.defaults = wl), (Ll.optionHandlers = xl);
  var kl = [];
  function Tl(e, t, r, n) {
    var i,
      o = e.doc;
    null == r && (r = "add"),
      "smart" == r && (o.mode.indent ? (i = dt(e, t).state) : (r = "prev"));
    ...
    if (n || /\S/.test(s.text)) {
      if (
        "smart" == r &&
        ((u = o.mode.indent(i, s.text.slice(c.length), s.text)) == U || u > 150)
      ) {
        if (!n) return;
        r = "prev";
      }
    ...
    "prev" == r
      ? (u = t > o.first ? R(Xe(o, t - 1).text, null, l) : 0)
      : "add" == r
    ...
    if ((f < u && (h += _(u - f)), h != c))
      return (
        ho(o, h, et(t, 0), et(t, c.length), "+input"), (s.stateAfter = null), !0
      );
  ...
  function Ol(e, t, r, n, i) {
    ...
    if (s && n.ranges.length > 1)
      if (Ml && Ml.text.join("\n") == t) {
        if (n.ranges.length % Ml.text.length == 0) {
          u = [];
          for (var c = 0; c < Ml.text.length; c++)
            u.push(o.splitLines(Ml.text[c]));
        }
      } else
    ...
    for (var h = e.curOp.updateInput, f = n.ranges.length - 1; f >= 0; f--) {
      ...
      d.empty() &&
        (r && r > 0
          ...
          ? (g = et(
              g.line,
              Math.min(Xe(o, g.line).text.length, g.ch + $(a).length)
            ))
          : s &&
            Ml &&
            Ml.lineWise &&
          ...
          if (o.electricChars) {
            ...
            o.electricInput &&
              o.electricInput.test(
                Xe(e.doc, i.head.line).text.slice(0, i.head.ch)
              ) &&
              (l = Tl(e, i.head.line, "smart"));
    ...
    function u(o) {
      ...
      if ("codepoint" == n) {
        ...
        l = i
          ? (function (e, t, r, n) {
              ...
              var s,
                a = function (e, r) {
                  return $o(t, e instanceof et ? e.ch : e, r);
                },
                u = function (r) {
                  return e.options.lineWrapping
                    ? ((s = s || Dr(e, t)), Zr(e, t, s, r))
      ...
      if (null == l) {
        if (
          ...
          (u = t.line + a) < e.first ||
          u >= e.first + e.size ||
          ((t = new et(u, t.ch, t.sticky)), !(s = Xe(e, u)))
        )
          return !1;
        t = Zo(i, e.cm, s, t.line, a);
      } else t = l;
      return !0;
    }
  ...
  function El(e, t, r, n) {
    ...
    if ("page" == n) {
      var a = Math.min(
        ...
        u = Math.max(a - 0.5 * en(e.display), 3);
  ...
  function Bl(e, t, r) {
    ...
    if (t == e.display.lineDiv) {
      if (!(n = e.display.lineDiv.childNodes[r]))
        return zl(e.clipPos(et(e.display.viewTo - 1)), !0);
      (t = null), (r = 0);
    } else
  ...
  (Il.prototype.init = function (e) {
    ...
    (Il.prototype.screenReaderLabelChanged = function (e) {
      e
    ...
    (Il.prototype.showPrimarySelection = function () {
      ...
      if (
        ...
        var l = Bl(t, e.anchorNode, e.anchorOffset),
          s = Bl(t, e.focusNode, e.focusOffset);
        if (
          !l ||
          l.bad ||
          !s ||
    ...
    (Il.prototype.pollSelection = function () {
      if (
        ...
        if (!this.composing) {
          this.rememberSelection();
          var r = Bl(t, e.anchorNode, e.anchorOffset),
            n = Bl(t, e.focusNode, e.focusOffset);
          r &&
            n &&
            qn(t, function () {
              qi(t.doc, Ci(r, n), V),
    ...
    (Il.prototype.pollContent = function () {
      ...
      if (
        (0 == l.ch &&
          l.line > n.firstLine() &&
          (l = et(l.line - 1, Xe(n.doc, l.line - 1).length)),
        ...
        return !1;
      l.line == i.viewFrom || 0 == (e = an(n, l.line))
      ...
      for (
        var h = n.doc.splitLines(
          ...
          f = Ye(n.doc, et(t, 0), et(a, Xe(n.doc, a).text.length));
  ...
  (Ul.prototype.init = function (e) {
    ...
    (Ul.prototype.setUneditable = function () {}),
    (Ul.prototype.needsContentAttribute = !1),
    (function (e) {
      ...
      (e.defineOption = r),
        ...
        r("lineSeparator", null, function (e, t) {
          if (((e.doc.lineSep = t), t)) {
            ...
            for (var i = r.length - 1; i >= 0; i--)
              ho(e.doc, t, r[i], et(r[i].line, r[i].ch + t.length));
          }
        }),
        r(
          "specialChars",
        ...
        r("readOnly", !1, function (e, t) {
          "nocursor" == t && (Sn(e), e.display.input.blur()),
        ...
        r("workTime", 100),
        r("workDelay", 100),
        r("flattenSpans", !0, Ni, !0),
        r("addModeClass", !1, Ni, !0),
        r("pollInterval", 100),
      ...
      (e.prototype = {
        ...
        removeOverlay: Qn(function (e) {
          for (var t = this.state.overlays, r = 0; r < t.length; ++r) {
            ...
            if (n == e || ("string" == typeof e && n.name == e))
              return t.splice(r, 1), this.state.modeGen++, void un(this);
          }
        }),
        ...
        indentSelection: Qn(function (e) {
          for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
            ...
            if (i.empty())
              i.head.line > r &&
                (Tl(this, i.head.line, e, !0),
                (r = i.head.line),
                n == this.doc.sel.primIndex && On(this));
            else {
              var o = i.from(),
                l = i.to(),
                s = Math.max(r, o.line);
              r = Math.min(this.lastLine(), l.line - (l.ch ? 0 : 1)) + 1;
              for (var a = s; a < r; ++a) Tl(this, a, e);
              var u = this.doc.sel.ranges;
              0 == o.ch &&
                t.length == u.length &&
                u[n].from().ch > 0 &&
                Yi(this.doc, n, new wi(o, u[n].to()), V);
            }
          }
        }),
        ...
        addWidget: function (e, t, r, n, i) {
          ...
          (t.style.top = u + "px"),
            ...
            r &&
              ...
              null != (s = Mn(o, l)).scrollTop && Hn(o, s.scrollTop),
              null != s.scrollLeft && Pn(o, s.scrollLeft));
        },
        triggerOnKeyDown: Qn(sl),
        triggerOnKeyPress: Qn(ul),
        triggerOnKeyUp: al,
        triggerOnMouseDown: Qn(dl),
        ...
        findPosH: function (e, t, r, n) {
          ...
          for (
            ...
            l < t && !(o = Pl(this.doc, o, i, r, n)).hitSide;
            ++l
          );
          return o;
        },
        ...
        findWordAt: function (e) {
          ...
          return new wi(et(e.line, r), et(e.line, n));
        },
        toggleOverwrite: function (e) {
        ...
        refresh: Qn(function () {
          ...
          un(this),
            ...
            li(this.display),
            (null == e ||
              Math.abs(e - en(this.display)) > 0.5 ||
  ...
  for (var Kl in No.prototype)
    No.prototype.hasOwnProperty(Kl) &&
      B(Vl, Kl) < 0 &&
      (Ll.prototype[Kl] = (function (e) {
        return function () {
  ...
  return (
    be(No),
    (Ll.inputStyles = { textarea: Ul, contenteditable: Il }),
    (Ll.defineMode = function (e) {
      Ll.defaults.mode || "null" == e || (Ll.defaults.mode = e),
        function (e, t) {
          arguments.length > 2 &&
    ...
    (Ll.defineMIME = function (e, t) {
      Ie[e] = t;
    }),
    Ll.defineMode("null", function () {
      return {
        token: function (e) {
          return e.skipToEnd();
        },
    ...
    Ll.defineMIME("text/plain", "null"),
    (Ll.defineExtension = function (e, t) {
      Ll.prototype[e] = t;
    }),
    (Ll.defineDocExtension = function (e, t) {
      No.prototype[e] = t;
    }),
    (Ll.fromTextArea = function (e, t) {
      if (
