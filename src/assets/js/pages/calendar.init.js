      ...
      o.append("<label>Change event name</label>"),
        o.append(
          "<div class='input-group'><input class='form-control' type=text value='" +
            n.title +
            "' /><span class='input-group-append'><button type='submit' class='btn btn-success waves-effect waves-light'><i class='fa fa-check'></i> Save</button></span></div>"
        ),
          ...
          return (
            null !== e && 0 != e.length
              ? (o.$calendarObj.fullCalendar(
                  "renderEvent",
                  { title: e, start: t, end: a, allDay: !1, className: n },
                  !0
                ),
                o.$modal.modal("hide"))
