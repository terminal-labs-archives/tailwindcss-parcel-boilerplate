...
(function (d) {
  ...
  m.instanceSelector = function (a, b) {
    ...
    var c = [],
      ...
      i = function (a) {
        if (d.isArray(a)) for (var f = 0, k = a.length; f < k; f++) i(a[f]);
        else
          "string" === typeof a
            ? -1 !== a.indexOf(",")
              ? i(a.split(","))
      ...
      var c = [],
        ...
        i = function (a, b) {
          ...
          if (d.isArray(a) || a instanceof d) {
            ...
            h = 0;
            for (g = f.length; h < g; h++) c.push({ inst: b, node: f[h].node });
            ...
            if (-1 !== a.indexOf(",")) {
              ...
              (h = d.map(f, function (a) {
                ...
                c.push({ inst: b, node: f[d.inArray(a, h)].node });
            else if (-1 !== a.indexOf(":name")) {
              var j = a.replace(":name", "");
              h = 0;
              for (g = f.length; h < g; h++)
                f[h].name === j && c.push({ inst: b, node: f[h].node });
            } else
              d(h)
                .filter(a)
                .each(function () {
        ...
        if (!a) {
          ...
          k && "absolute" === g
            ...
            ? (e._collection.css({
              ...
              c > d(p).width() &&
                e._collection.css("left", a.left - (c - d(p).width())))
  ...
  j.Api.registerPlural(
    ...
    function () {
      ...
      this.iterator(!0, "table", function (c) {
        if (c._buttons)
          for (
            var c = m.instanceSelector(b, c._buttons), d = 0, i = c.length;
            d < i;
            d++
          )
