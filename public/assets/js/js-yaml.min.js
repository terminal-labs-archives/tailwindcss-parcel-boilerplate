...
!(function (e, t) {
  ...
  var y = new p("tag:yaml.org,2002:bool", {
    kind: "scalar",
    resolve: function (e) {
      if (null === e) return !1;
      var t = e.length;
  ...
  var v = new p("tag:yaml.org,2002:int", {
      kind: "scalar",
      resolve: function (e) {
        if (null === e) return !1;
        var t,
  ...
  var k = /^[-+]?[0-9]+e/;
  var C = new p("tag:yaml.org,2002:float", {
      kind: "scalar",
      resolve: function (e) {
        return null !== e && !(!w.test(e) || "_" === e[e.length - 1]);
      },
      construct: function (e) {
        var t, n;
        return (
      ...
      represent: function (e, t) {
        ...
        return (i = e.toString(10)), k.test(i) ? i.replace("e", ".e") : i;
      },
      defaultStyle: "lowercase",
    }),
    x = g.extend({ implicit: [m, y, v, C] }),
    I = x,
  ...
  var j = new p("tag:yaml.org,2002:timestamp", {
    kind: "scalar",
    resolve: function (e) {
      return null !== e && (null !== S.exec(e) || null !== O.exec(e));
    },
    construct: function (e) {
      var t,
        n,
        ...
        s = 0,
        u = null;
      if ((null === (t = S.exec(e)) && (t = O.exec(e)), null === t))
  ...
  var T = new p("tag:yaml.org,2002:merge", {
      kind: "scalar",
      resolve: function (e) {
        return "<<" === e || null === e;
      },
  ...
  var F = new p("tag:yaml.org,2002:binary", {
      kind: "scalar",
      resolve: function (e) {
        if (null === e) return !1;
        var t,
  ...
  var L = new p("tag:yaml.org,2002:omap", {
      kind: "sequence",
      resolve: function (e) {
        if (null === e) return !0;
        var t,
        ...
        for (t = 0, n = l.length; t < n; t += 1) {
          if (((i = l[t]), (o = !1), "[object Object]" !== M.call(i)))
            return !1;
          for (r in i)
            if (E.call(i, r)) {
              if (o) return !1;
  ...
  var D = new p("tag:yaml.org,2002:pairs", {
      kind: "sequence",
      resolve: function (e) {
        if (null === e) return !0;
        var t,
  ...
  var Y = new p("tag:yaml.org,2002:set", {
      kind: "mapping",
      resolve: function (e) {
        if (null === e) return !0;
        var t,
    ...
    q = I.extend({ implicit: [j, T], explicit: [F, L, D, Y] }),
    R = Object.prototype.hasOwnProperty,
    B = /[\x00-\x08\x0B\x0C\x0E-\x1F\x7F-\x84\x86-\x9F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]/,
    K = /[\x85\u2028\u2029]/,
    P = /[,\[\]\{\}]/,
    W = /^(?:!|!!|![a-z\-]+!)$/i,
  ...
  for (var ee = new Array(256), te = new Array(256), ne = 0; ne < 256; ne++)
    (ee[ne] = z(ne) ? 1 : 0), (te[ne] = z(ne));
  function ie(e, t) {
    (this.input = e),
  ...
  var le = {
    YAML: function (e, t, n) {
      var i, r, o;
      null !== e.version && oe(e, "duplication of %YAML directive"),
        1 !== n.length && oe(e, "YAML directive accepts exactly one argument"),
        null === (i = /^([0-9]+)\.([0-9]+)$/.exec(n[0])) &&
          oe(e, "ill-formed argument of the YAML directive"),
        (r = parseInt(i[1], 10)),
        (o = parseInt(i[2], 10)),
        1 !== r && oe(e, "unacceptable YAML version of the document"),
        (e.version = n[0]),
        (e.checkLineBreaks = o < 2),
        1 !== o && 2 !== o && ae(e, "unsupported YAML version of the document");
    },
    TAG: function (e, t, n) {
      var i, r;
      2 !== n.length && oe(e, "TAG directive accepts exactly two arguments"),
        (i = n[0]),
        (r = n[1]),
        W.test(i) ||
          oe(e, "ill-formed tag handle (first argument) of the TAG directive"),
        R.call(e.tagMap, i) &&
          oe(
            e,
        ...
        H.test(r) ||
          oe(e, "ill-formed tag prefix (second argument) of the TAG directive");
      try {
        r = decodeURIComponent(r);
      } catch (t) {
        oe(e, "tag prefix is malformed: " + r);
      }
      e.tagMap[i] = r;
    },
  };
    ...
    if (t < n) {
      if (((l = e.input.slice(t, n)), i))
        for (r = 0, o = l.length; r < o; r += 1)
          9 === (a = l.charCodeAt(r)) ||
            (32 <= a && a <= 1114111) ||
            oe(e, "expected valid JSON character");
      else B.test(l) && oe(e, "the stream contains non-printable characters");
      e.result += l;
    }
  }
  function se(e, t, i, r) {
    ...
    for (
      ...
      (a = o[l]), R.call(t, a) || ((t[a] = i[a]), (r[a] = !0));
  }
  function ue(e, t, n, i, r, o, a, l, c) {
    var s, u;
    if (Array.isArray(r))
      for (s = 0, u = (r = Array.prototype.slice.call(r)).length; s < u; s += 1)
        Array.isArray(r[s]) &&
          oe(e, "nested arrays are not supported inside keys"),
          "object" == typeof r &&
            "[object Object]" === $(r[s]) &&
            (r[s] = "[object Object]");
    if (
      ...
      if (Array.isArray(o))
        for (s = 0, u = o.length; s < u; s += 1) se(e, t, o[s], n);
      else se(e, t, o, n);
    else
      e.json ||
        R.call(n, r) ||
  ...
  function fe(e, t, n) {
    for (var i = 0, r = e.input.charCodeAt(e.position); 0 !== r; ) {
      ...
      if (!G(r)) break;
      for (
        pe(e), r = e.input.charCodeAt(e.position), i++, e.lineIndent = 0;
        32 === r;
    ...
    return (
      -1 !== n && 0 !== i && e.lineIndent < n && ae(e, "deficient indentation"),
      i
    );
  }
  function de(e) {
  ...
  function ge(e, t) {
    ...
    for (
      ...
      (-1 !== e.firstTabInLine &&
        ...
        oe(e, "tab characters must not be used in indentation")),
      45 === i) &&
      Z(e.input.charCodeAt(e.position + 1));

    )
      if (((l = !0), e.position++, fe(e, !0, -1) && e.lineIndent <= t))
  ...
  function me(e) {
    ...
    if (
      (null !== e.tag && oe(e, "duplication of a tag property"),
      ...
      e.position < e.length
        ? ((i = e.input.slice(t, e.position)),
          (r = e.input.charCodeAt(++e.position)))
        : oe(e, "unexpected end of the stream within a verbatim tag");
    } else {
      for (; 0 !== r && !Z(r); )
        33 === r &&
          (a
            ? oe(e, "tag suffix cannot contain exclamation marks")
            : ((n = e.input.slice(t - 1, e.position + 1)),
              W.test(n) ||
                oe(e, "named tag handle cannot contain such characters"),
              (a = !0),
              (t = e.position + 1))),
          (r = e.input.charCodeAt(++e.position));
      (i = e.input.slice(t, e.position)),
        P.test(i) &&
          oe(e, "tag suffix cannot contain flow indicator characters");
    }
    i && !H.test(i) && oe(e, "tag name cannot contain such characters: " + i);
    try {
      i = decodeURIComponent(i);
    } catch (t) {
      oe(e, "tag name is malformed: " + i);
    }
    return (
      o
        ? (e.tag = i)
  ...
  function ye(e) {
    ...
    for (
      null !== e.anchor && oe(e, "duplication of an anchor property"),
    ...
    return (
      e.position === t &&
        oe(e, "name of an anchor node must contain at least one character"),
  ...
  function be(e, t, i, r, o) {
    ...
    if (
          ...
          ? (c &&
                  ...
                  for (
                    ...
                    if (
                      ((e.line === o || e.lineIndent > t) &&
                        ...
                        y ||
                          (ue(e, f, d, h, g, m, a, l, c), (h = g = m = null)),
                        fe(e, !0, -1),
                        (s = e.input.charCodeAt(e.position))),
            ...
            (function (e, t) {
              ...
              for (
                ...
                if ((fe(e, !0, t), (d = e.input.charCodeAt(e.position)) === a))
                  return (
                    e.position++,
                    (e.tag = g),
                    (e.anchor = m),
                ...
                h
                  ? 44 === d &&
                    oe(e, "expected the node content, but found ','")
                  : oe(e, "missed comma between flow collection entries"),
                  (f = null),
                  (l = c = !1),
                  63 === d &&
                    Z(e.input.charCodeAt(e.position + 1)) &&
                    ((l = c = !0), e.position++, fe(e, !0, t)),
                  (n = e.line),
                  (i = e.lineStart),
                  (r = e.position),
                  be(e, t, 1, !1, !0),
                  ...
                  (!c && e.line !== n) ||
                    ...
                    (f = e.result)),
                  s
                    ? ue(e, o, y, p, u, f, n, i, r)
                    : l
                    ? o.push(ue(e, null, y, p, u, f, n, i, r))
                    : o.push(u),
                  fe(e, !0, t),
            ...
            : ((l &&
                (function (e, t) {
                  ...
                  for (e.kind = "scalar", e.result = ""; 0 !== a; )
                    if (
                      ...
                      1 === c
                        ? (c = 43 === a ? 3 : 2)
                        : oe(e, "repeat of a chomping mode identifier");
                    else {
                      ...
                      0 === o
                        ...
                        : u
                        ? oe(e, "repeat of an indentation width identifier")
                        : ((p = t + o - 1), (u = !0));
                    }
                  if (V(a)) {
                    do {
                  ...
                  for (; 0 !== a; ) {
                    ...
                    if ((!u && e.lineIndent > p && (p = e.lineIndent), G(a)))
                      f++;
                    else {
                      if (e.lineIndent < p) {
                        3 === c
              ...
              (function (e, t) {
                ...
                for (
                  ...
                  if (34 === l)
                    return ce(e, n, e.position, !0), e.position++, !0;
                  if (92 === l) {
                    if (
                      (ce(e, n, e.position, !0),
                      ...
                      for (r = a, o = 0; r > 0; r--)
                        (a = Q((l = e.input.charCodeAt(++e.position)))) >= 0
                          ? (o = (o << 4) + a)
                          : oe(e, "expected hexadecimal character");
                      (e.result += X(o)), e.position++;
                    } else oe(e, "unknown escape sequence");
                    n = i = e.position;
                  } else
                    G(l)
                      ? (ce(e, n, i, !0),
                ...
                : !(function (e) {
                    ...
                    return (
                      ...
                      R.call(e.anchorMap, n) ||
                        oe(e, 'unidentified alias "' + n + '"'),
                ...
                : ((y = !0),
                  (null === e.tag && null === e.anchor) ||
                    oe(e, "alias node should not have any properties")),
      ...
      if (R.call(e.typeMap[e.kind || "fallback"], e.tag))
      ...
      f || oe(e, "unknown tag !<" + e.tag + ">"),
        ...
        f.resolve(e.result, e.tag)
          ? ((e.result = f.construct(e.result, e.tag)),
            null !== e.anchor && (e.anchorMap[e.anchor] = e.result))
          : oe(e, "cannot resolve a node with !<" + e.tag + "> explicit tag");
    }
    return (
  ...
  function Ae(e) {
    ...
    for (
      ...
      for (
        ...
        for (; V(r); ) r = e.input.charCodeAt(++e.position);
        if (35 === r) {
          do {
            r = e.input.charCodeAt(++e.position);
          } while (0 !== r && !G(r));
      ...
      0 !== r && pe(e),
        R.call(le, n)
          ? le[n](e, n, i)
          : ae(e, 'unknown document directive "' + n + '"');
    }
    fe(e, !0, -1),
      0 === e.lineIndent &&
      ...
      45 === e.input.charCodeAt(e.position + 2)
        ? ((e.position += 3), fe(e, !0, -1))
        : a && oe(e, "directives end mark is expected"),
      be(e, e.lineIndent - 1, 4, !1, !0),
      fe(e, !0, -1),
      e.checkLineBreaks &&
        K.test(e.input.slice(o, e.position)) &&
        ae(e, "non-ASCII line breaks are interpreted as content"),
      e.documents.push(e.result),
      e.position === e.lineStart && de(e)
        ? 46 === e.input.charCodeAt(e.position) &&
          ((e.position += 3), fe(e, !0, -1))
        : e.position < e.length - 1 &&
          oe(e, "end of the stream or a document separator is expected");
  }
  function ve(e, t) {
    (t = t || {}),
      0 !== (e = String(e)).length &&
    ...
    for (
      -1 !== i &&
        ((n.position = i), oe(n, "null byte is not allowed in input")),
        n.input += "\0";
  ...
  function Me(e) {
    return (
      ...
      (57344 <= e && e <= 65533 && e !== xe) ||
      (65536 <= e && e <= 1114111)
    );
  }
  function Le(e) {
    return Me(e) && e !== xe && 13 !== e && 10 !== e;
  }
  function _e(e, t, n) {
    var i = Le(e),
      r = i && !Ee(e);
  ...
  function qe(e, t, n, i, r) {
    e.dump = (function () {
      ...
      if (!e.noCompatMode && (-1 !== Se.indexOf(t) || Oe.test(t)))
      ...
      switch (
        ...
        case 2:
          return "'" + t.replace(/'/g, "''") + "'";
        case 3:
          return "|" + Re(t, e.indent) + Be(Ne(t, a));
        case 4:
          return (
            ">" +
            Re(t, e.indent) +
  ...
  function Pe(e, t, n, i) {
    ...
    for (r = 0, o = n.length; r < o; r += 1)
      (a = n[r]),
        ...
        (He(e, t + 1, a, !0, !0, !1, !0) ||
          (void 0 === a && He(e, t + 1, null, !0, !0, !1, !0))) &&
          ((i && "" === l) || (l += Fe(e, t)),
      ...
      if (
        ...
        if (
          ...
          if (
            ...
            "[object Function]" === ke.call(c.represent))
          )
            i = c.represent(t, s);
          else {
            if (!Ce.call(c.represent, s))
              throw new o(
  ...
  function $e(e, t) {
    var n,
      ...
      r = [],
      o = [];
    for (Ge(e, r, o), n = 0, i = o.length; n < i; n += 1)
  ...
  function Ge(e, t, n) {
    ...
    if (null !== e && "object" == typeof e)
      if (-1 !== (r = t.indexOf(e))) -1 === n.indexOf(r) && n.push(r);
        ...
        for (r = 0, o = e.length; r < o; r += 1) Ge(e[r], t, n);
      else
